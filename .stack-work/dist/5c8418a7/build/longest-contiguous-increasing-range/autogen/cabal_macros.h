...
/* package longest-contiguous-increasing-range-0.1.0.0 */
#ifndef VERSION_longest_contiguous_increasing_range
#define VERSION_longest_contiguous_increasing_range "0.1.0.0"
#endif /* VERSION_longest_contiguous_increasing_range */
#ifndef MIN_VERSION_longest_contiguous_increasing_range
#define MIN_VERSION_longest_contiguous_increasing_range(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_longest_contiguous_increasing_range */
...
#define CURRENT_COMPONENT_ID "longest-contiguous-increasing-range-0.1.0.0-8ruTeR8BXCeL5q29YPgLQ0-longest-contiguous-increasing-range"
